...
1. **Análise de Dados Financeiros**
   ...
   ![Exemplo de Gráficos Financeiros](/img/dashboard.png)
...
2. **Simulações de Cenários "What If"**
   ...
   ![Exemplo de Simulação "What If"](/img/what_if.png)
...
3. **Previsão e Modelagem**
   ...
   ![Exemplo de Previsão](/img/grafico_receita.png)
...
<iframe 
  ...
  src="https://www.youtube.com/embed/qU9mHegkTc4?start_radio=1&list=RDqU9mHegkTc4" 
  frameborder="0" 
